...
python -m scheduler_clustered.visualization clustered_cvar_results.json --show
python -m scheduler_clustered.visualization deterministic.json --compare cvar.json
"""

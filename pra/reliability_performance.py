thresholds_map = {'high_loading_percent': 90.0,   'low_vm_pu': .95, 'hihg_vm_pu': 1.05}


def g_fun_loading(loading_percent, upper_threshold):
...
def g_fun_low_voltage_magnitude(voltage_magnitudes_pu, lower_thresholds = None):
...
def g_fun_low_voltage_magnitude(voltage_magnitudes_pu, upper_thresholds=None):
    ...
    if upper_thresholds is not None and len(upper_thresholds) == len(voltage_magnitudes_pu):
        ...
        g = voltage_magnitudes_pu - thresholds_map['hihg_vm_pu']
